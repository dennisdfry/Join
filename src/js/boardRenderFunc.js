...
window.htmlboard = async function(index, category, title, description, date, prio) {
    return `
    <div draggable="true" ondragstart="startDragging(${index[taskkeys]})" onclick="openTaskToBoardRender(${index}, '${category}', '${title}', '${description}', '${date}', '${prio}')" class="board-task-container" id="parentContainer${index}">
